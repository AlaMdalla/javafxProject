...
public class HelloController implements Initializable {
    ...
    private void loadSponsorPageView() {
        try {
            ...
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/com/example/jobflow/back/evenement/sponsor.fxml"));
        ...
        btnupdate.setOnMouseClicked(mouseEvent -> {
            ...
            if (selectedEvent != null) {
                try {
                    ...
                    FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/jobflow/back/evenement/modifier.fxml"));
