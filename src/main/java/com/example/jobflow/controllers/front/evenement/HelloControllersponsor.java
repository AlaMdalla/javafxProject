...
public class HelloControllersponsor implements Initializable {
    ...
    private void generateQRCodeForSponsor(int sponsorId) {
        ...
        String path = "C:\\Users\\ufl\\Downloads\\sponsor_" + sponsorId + ".jpg";
    ...
    private void loadSponsorPageView() {
        try {
            ...
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/com/example/jobflow/front/evenement/hello-view.fxml"));
        ...
        btnUpdates.setOnMouseClicked(mouseEvent -> {
            ...
            if (selectedEvent != null) {
                try {
                    ...
                    FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/jobflow/front/evenement/modifiersponsor.fxml"));
