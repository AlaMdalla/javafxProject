...
public class  Comments_back implements Initializable {
    ...
    public void navigatetoback(ActionEvent actionEvent) {
        try{
            Parent root =
                    FXMLLoader.load(getClass().getResource("/com/example/jobflow/front/posts/back/Posts.fxml"));
    ...
    public void vavtocomments(ActionEvent actionEvent) {
        try {
            // Load the FXML file
            Parent root = FXMLLoader.load(getClass().getResource("/com/example/jobflow/front/posts/back/Comments.fxml"));
