...
public class AfficherPartenaire implements Initializable {
    ...
    private void ajouterPartenaire() {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/jobflow/back/societe/AfficherPartenaire.fxml"));
        Parent root;
        try {
            root = loader.load();
    ...
    private void modifierPartenaire(Partenaire partenaire) throws IOException {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/jobflow/back/societe/ModifierPartenaire.fxml"));
    ...
    void goToMainWindow(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/jobflow/back/societe/MainWindow.fxml"));
            Parent root = loader.load();
            Stage currentStage = (Stage) partenaireListView.getScene().getWindow();
            currentStage.setScene(new Scene(root));
        } catch (IOException e) {
