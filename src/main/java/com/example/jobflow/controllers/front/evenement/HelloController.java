...
import com.example.jobflow.entities.evenement;
...
public class HelloController implements Initializable {
    ...
    private void loadSponsorPageView() {
        try {
            ...
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/com/example/jobflow/front/evenement/sponsor.fxml"));
        ...
        btnupdate.setOnMouseClicked(mouseEvent -> {
            ...
            if (selectedEvent != null) {
                try {
                    ...
                    FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/jobflow/front/evenement/modifier.fxml"));
...
*/
        ...
        card.getChildren().addAll(detailsBox, imageafficher );
    ...
    void creatEvenement(ActionEvent event) {
        ...
        try {
            ...
            st.setTime(6, Time.valueOf(heure));
