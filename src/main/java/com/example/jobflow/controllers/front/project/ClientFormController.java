...
import com.example.jobflow.emoji.EmojiPicker;
...
public class ClientFormController {
    ...
    public void sendButtonOnAction(ActionEvent actionEvent) {
        ...
        if (!message.isEmpty()) {
            if (BadWordDetector.containsBadWord(message)) {
                // Inform the user that the message contains a bad word
                // For example, display an alert
                showAlert("Warning", "Your message contains a bad word. Please revise it.");
            } else {
                sendMsg(message);
            }
        }
