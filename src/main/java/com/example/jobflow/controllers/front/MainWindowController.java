package com.example.jobflow.controllers.front;
...
public class MainWindowController implements Initializable {
    ...
    @FXML
    private void showProject(ActionEvent ignored) {
        goToLink(Constants.FXML_FRONT_MY_Project);

        btnProfile.setTextFill(COLOR_PRIMARY);
        Animations.animateButton(btnProfile, COLOR_GRAY, Color.WHITE, COLOR_PRIMARY, 0, false);
    }
    @FXML
    private void showSociete(ActionEvent ignored) {
        goToLink(Constants.FXML_FRONT_MY_Societe);

        btnProfile.setTextFill(COLOR_PRIMARY);
        Animations.animateButton(btnProfile, COLOR_GRAY, Color.WHITE, COLOR_PRIMARY, 0, false);
    }
    @FXML
    private void showPartenaire(ActionEvent ignored) {
    ...
    @FXML
    private void showPosts(ActionEvent ignored) {
        goToLink(Constants.FXML_FRONT_MY_Posts);
    ...
    private void afficherOpportunites(ActionEvent ignored) {
        goToLink(Constants.FXML_FRONT_DISPLAY_ALL_OPPORTUNITE);
    ...
    private void afficherTests(ActionEvent ignored) {
        goToLink(Constants.FXML_FRONT_DISPLAY_ALL_TEST);
